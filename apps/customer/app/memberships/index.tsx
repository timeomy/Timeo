...
export default function MembershipsScreen() {
  ...
  const { data: memberships, isLoading } = useMemberships(activeTenantId);
  const { mutateAsync: subscribe } = useSubscribeToMembership(
    activeTenantId ?? ""
  );
  ...
  const handleSubscribe = useCallback(
    async (membershipId: string) => {
      ...
      try {
        await subscribe(membershipId);
        Alert.alert("Success", "You have subscribed to this membership.");
      } catch (err) {
        const message =
