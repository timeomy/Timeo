...
export default function TenantDetailPage() {
  ...
  const { data: platformTenant } = usePlatformTenant(tenantId);
  const updateTenantSettingsMutation = useUpdateTenantSettings(tenantId);
  const updatePlatformTenantMutation = useUpdatePlatformTenant();
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Show this business in the customer directory
                </p>
              </div>
              <Toggle
                checked={platformTenant?.is_public ?? false}
                  ...
                  try {
                    ...
                    alert(
                      err instanceof Error
                        ? err.message
                        : "Failed to update directory visibility.",
                    );
                  }
                }}
              />
