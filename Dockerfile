# DEPRECATED — Use infra/web/Dockerfile instead.
# This file exists only for backwards compatibility.
# The production Docker Compose (docker-compose.prod.yml) uses infra/web/Dockerfile.
...
ARG NEXT_PUBLIC_SITE_URL=https://timeo.my
